...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row relative font-sans bg-white text-slate-800">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 bg-white min-h-screen overflow-y-auto">
        <div className="w-full max-w-md my-auto py-12">
          
          <Link href="/" className="flex lg:hidden items-center gap-2 mb-10 justify-center cursor-pointer">
            <div className="w-10 h-10 bg-blue-700 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">S</div>
          ...
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-4xl font-extrabold text-slate-900 mb-3 tracking-tight">เข้าสู่ระบบ</h2>
            <p className="text-slate-500 font-medium text-lg leading-relaxed">กรุณากรอกอีเมลและรหัสผ่านของคุณเพื่อดำเนินการต่อ</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button 
              ...
              className="flex items-center justify-center gap-3 w-full px-4 py-4 bg-white border border-slate-200 rounded-2xl shadow-sm hover:bg-slate-50 hover:border-slate-300 hover:shadow-md transition-all duration-300 font-bold text-slate-700 active:scale-[0.98] cursor-pointer"
            >
            ...
            <button 
              type="button"
              className="flex items-center justify-center gap-3 w-full px-4 py-4 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-2xl shadow-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 font-bold active:scale-[0.98] cursor-pointer"
            >
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-slate-400 font-bold uppercase tracking-widest text-[10px]">หรือใช้อีเมลของคุณ</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-2 ml-1">อีเมล (Email)</label>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 focus:bg-white outline-none transition-all font-medium text-slate-800" 
                  required 
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-bold text-slate-700 mb-2 ml-1">รหัสผ่าน (Password)</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-4 flex items-center text-slate-400">
                ...
                <input 
                  ...
                  placeholder="••••••••" 
                  className="w-full pl-12 pr-12 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 focus:bg-white outline-none transition-all font-medium text-slate-800" 
                  required 
                />
                <button 
                  type="button" 
                  onClick={togglePassword} 
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-blue-600 transition cursor-pointer"
                >
                  {passwordVisible ? (
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className="text-sm text-slate-600 font-medium select-none">จำฉันไว้</span>
              </label>
              <a href="#" className="text-sm font-bold text-blue-600 hover:underline">ลืมรหัสผ่าน?</a>
            </div>

            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-blue-700 hover:bg-blue-800 text-white font-extrabold py-5 rounded-2xl transition-all shadow-xl shadow-blue-700/20 active:scale-[0.98] mt-4 text-lg cursor-pointer"
            >
              {isLoading ? (
