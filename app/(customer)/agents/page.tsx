...
/**
 * page.tsx (Agents List) - หน้ารายการรายชื่อตัวแทนนายหน้าทั้งหมด
 * เหมาะสำหรับมือใหม่: แสดงวิธีกรองอาเรย์ข้อมูลนายหน้า (Agents Array)
 * พร้อมแสดงการผูกตัวแปรเพื่อคลิกติดต่อทางห้องแชทโดยตรง
 */
...
export default function AgentsPage() {
  ...
  // ดึงประวัติโปรไฟล์จาก Context
  const { profile } = useApp();

  // รายการรายชื่อนายหน้าทั้งหมด
  const agents: Agent[] = [
    {
      id: 1,
  ...
  // ฟังก์ชันกรองรายชื่อนายหน้าจากช่องป้อนและตำแหน่ง
  ...
  return (
    <div className="font-sans bg-slate-50 min-h-screen text-slate-800 antialiased overflow-x-hidden text-sm flex flex-col">
        ...
        <div className="max-w-5xl mx-auto px-4 h-full">
          <div className="flex justify-between items-center h-full">
            ...
            <div className="hidden lg:flex space-x-1 items-center bg-slate-100/50 p-0.5 rounded-full border border-slate-200">
              ...
              <Link href="/agents" className="text-blue-700 bg-white shadow-sm rounded-full px-4 py-1.5 text-xs font-bold transition">นายหน้าของเรา</Link>
      ...
      {/* แบนเนอร์ด้านบน */}
      <div className="bg-slate-900 pt-24 pb-12 relative overflow-hidden flex-shrink-0">
