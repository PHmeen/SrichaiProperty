...
/**
 * ==============================================================================
 * หน้าต่างลอยแสดงนโยบายความเป็นส่วนตัวและข้อตกลงการใช้งาน (Policy Modal Component)
 * /components/auth/PolicyModal.tsx
 * ==============================================================================
 * วัตถุประสงค์:
 * 1. แสดง Pop-up อ่านนโยบายความเป็นส่วนตัว (PDPA) หรือ ข้อตกลงการใช้งาน (Terms)
 * 2. มีปุ่มกด "เข้าใจและยอมรับ" เพื่อปิด Modal
 * ==============================================================================
 */

/** Props สำหรับ PolicyModal Component */
interface PolicyModalProps {
  policyType: 'privacy' | 'terms' | null; // ประเภทนโยบายที่เปิดดูอยู่ ('privacy' = นโยบายส่วนบุคคล, 'terms' = ข้อตกลง)
