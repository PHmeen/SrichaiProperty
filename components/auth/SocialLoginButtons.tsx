...
/**
 * ==============================================================================
 * ปุ่มเข้าสู่ระบบด้วยโซเชียลมีเดีย (Social Login Buttons Component)
 * /components/auth/SocialLoginButtons.tsx
 * ==============================================================================
 * วัตถุประสงค์:
 * 1. แสดงปุ่มเข้าสู่ระบบด่วนด้วยบัญชี Google และ Facebook
 * 2. เรียกใช้ฟังก์ชัน `signIn` ของ NextAuth เพื่อสลับไปยืนยันตัวตนกับ Provider ที่เลือก
 * ==============================================================================
 */
