# 🗄️ โครงสร้างฐานข้อมูล Srichai Property (27 ตารางแบบละเอียด)

เอกสารนี้รวบรวม **SQL DDL Script** สำหรับสร้างตารางทั้ง **27 ตาราง** บน Supabase/PostgreSQL พร้อมการเชื่อมโยงความสัมพันธ์ (Foreign Keys) และการตั้งค่าความปลอดภัย (RLS) เพื่อใช้เป็นฐานข้อมูลหลักในการส่งรูปเล่มและรันระบบจริง

---

## 🚀 สคริปต์ SQL สำหรับสร้างตาราง (รันใน Supabase SQL Editor)
...
-- แทรกประเภทเริ่มต้น
INSERT INTO property_types (name) VALUES ('บ้านเดี่ยว'), ('ทาวน์โฮม'), ('คอนโดมิเนียม');
...
## 🔒 การสร้างดัชนีประสิทธิภาพและการรักษาความปลอดภัย (Indexes & Security)

คัดลอกส่วนนี้ไปรันเพิ่มเติม เพื่อช่วยให้ความเร็วในการค้นหาประกาศรวดเร็วขึ้น:
...
-- นโยบาย RLS ตัวอย่าง:
-- 1. ทุกคนสามารถอ่านประกาศที่ได้รับอนุมัติ (Approved) แล้วได้
CREATE POLICY "Public read approved properties" ON properties 
    FOR SELECT USING (status = 'approved');

-- 2. เฉพาะลูกค้าหรือนายหน้าที่คู่กรณีนัดหมายเท่านั้นที่จะสืบค้นแชทได้
